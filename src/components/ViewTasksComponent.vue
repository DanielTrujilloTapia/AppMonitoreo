...
export default {
    ...
    methods: {
        ...
        async GetTasks() {
            try {
                const responseTasks = await fetch('https://192.168.1.78:7296/api/Tareas_Servicios');
            ...
            try {
                const responseStatus = await fetch('https://192.168.1.78:7296/api/Tareas_Estatus');
