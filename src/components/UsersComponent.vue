  ...
  export default {
    ...
    methods: {
      async Get_Datas() {
        ...
        try {
          const responseEstados = await fetch('https://192.168.1.78:7296/api/Usu_Estados_Usuarios');
        ...
        try {
          const responseTipos = await fetch('https://192.168.1.78:7296/api/Usu_Tipos_Usuarios');
        ...
        try {
          const responsePuestos = await fetch('https://192.168.1.78:7296/api/Usu_Puestos_Usuarios');
