...
export default {
    ...
    methods: {
        async GetDatas() {
            /* Consulta SERVICIOS */
            try {
                const responseServices = await fetch('https://sitemapiapp20240812132426.azurewebsites.net/api/Cat_Servicios');
...
/**************************************FECHA Y HORA *************************************************************/
        ...
        async CreatedTask(){ 
            ...
            if(this.nameTask !== null && this.id_servicio !== null && this.id_encargado !== null && this.id_ayudante !== null && this.id_planta !== null && this.selectedDate !== null && this.id_prioridades !== null){
                ...
                try {
                    const createdTaskService = await fetch('https://sitemapiapp20240812132426.azurewebsites.net/api/Tareas_Servicios', {
                    method: 'POST',
                    headers: {
